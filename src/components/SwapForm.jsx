...
const SwapForm = ({ isWalletConnected, walletAddress }) => {
  ...
  const settlementContractAddress = () => {
    if (originChain.toString() === "11155111")
      return "0x3544a69a05569388C4Ba9CA5208A5CcB2B945Ac6";
    if (originChain.toString() === "84532")
      return "0x64f756EE9f17d040610006Ff5a3BB52b58E6066E";
    if (originChain.toString() === "534351")
      return "0x64f756EE9f17d040610006Ff5a3BB52b58E6066E";
    return "0x0";
  };
  ...
  async function createOrder() {
    ...
    return {
      ...
      initiateDeadline:
        Math.floor(Date.now() / 1000) + parseInt(deadline.toString()),
      fillDeadline:
        Math.floor(Date.now() / 1000) + parseInt(deadline.toString()),
